...
#ifdef KE_APP
#define CG_X_TO_GL(_x, _deviceSize)		_x
#define CG_Y_TO_GL(_y, _deviceSize)		_y
#define TEX_X_TO_VER(_x, _deviceSize)	_x
#define TEX_Y_TO_VER(_y, _deviceSize)	_y
#define VER_X_TO_TEX(_x, _deviceSize)	_x
#define VER_Y_TO_TEX(_y, _deviceSize)	_y
#else
